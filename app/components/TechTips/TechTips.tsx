  ...
  const techTips = [
    {
      ...
      description: "Discover the advantages of hosting your website or application with 8Ts secure and scalable cloud hosting solutions.",
      date: "March 15, 2024",
      readTime: "1 min",
    },
    {
      ...
      description: "Learn how 8Ts data processing services can help you make sense of your data and drive business growth.",
    ...
    },
    {
      ...
      description: "Explore how 8Ts website development and design services can help you create a stunning online presence that drives results.",
